...
#Region "Properties"
        ...
        'Public Property SearchIntervalle As Intervalle
        '    Get
        '        Return New Intervalle With {.Min_Value = minPosition, .Max_Value = maxPosition}
        '    End Get
        '    Set(value As Intervalle)
        '        If IsNothing(value) = False Then
        '            If value.Min_Value < value.Max_Value Then
        '                minPosition = value.Min_Value
        '                maxPosition = value.Max_Value
        '            Else
        '                Throw New Exception("Intervalle.MinValue must be < Intervalle.MaxValue.")
        '            End If
        '        Else
        '            Throw New ArgumentNullException("SearchIntervalle", "SearchIntervalle must be non null.")
        '        End If
        '    End Set
        'End Property
        ...
        Private Function GWO_Minimization(ByVal dimensionD As Integer, ByVal iterationsMax As Integer, ByVal wolfCountN As Integer) As Double()
            Try
                ...
                Do While iteration < iterationsMax
                    ...
                    Me.MeanChart.Add((meanFitness / wolfCountN))
