...
Imports EvolutionaryAlgorithms

Namespace GravitationalSearchAlgorithm

    Public Class GSAOptimizer0
...
#Region "Public Var"
        ...
        Public ReadOnly Property MeanChart As List(Of Double) Implements IEvolutionaryAlgorithm.MeanChart
            Get
                Return Mean_Chart
            End Get
        End Property
        ...
        Public ReadOnly Property WorstChart As List(Of Double) Implements IEvolutionaryAlgorithm.WorstChart
            Get
                Return Worst_Chart
            End Get
        End Property
        ...
        Dim mMaxIterations As Integer = 1I
        Private Property MaxIterations As Integer Implements IEvolutionaryAlgorithm.MaxIterations
            Get
        ...
        Private mOptimizationType As OptimizationTypeEnum = OptimizationTypeEnum.Minimization
        ...
        Private mSolution_Fitness As Dictionary(Of String, Double)
...
#End Region
        ...
        Private Sub Initialize()
            ...
            Next
            Rand = New Random()
            Me.Best_Chart = New List(Of Double)
            Me.Mean_Chart = New List(Of Double)
            Me.Worst_Chart = New List(Of Double)
