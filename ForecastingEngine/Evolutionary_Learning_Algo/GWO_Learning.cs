...
namespace ForecastingEngine.Evolutionary_Learning_Algo
{
    ...
    public class GWO_Learning : ISupervisedLearning
    {
        ...
        private GWOptimizer Optimizer;

        public GWO_Learning(ActivationNetwork activationNetwork, int populationSize, int maxIterations, GWOVersionEnum version, double IGWO_u)
        {
            ...
            Optimizer = new GWOptimizer(numberOfNetworksWeights, populationSize, maxIterations);
            Optimizer.OptimizationType = OptimizationTypeEnum.Minimization;
            Optimizer.GWOVersion = version;
            Optimizer.IGWO_uParameter = IGWO_u;
