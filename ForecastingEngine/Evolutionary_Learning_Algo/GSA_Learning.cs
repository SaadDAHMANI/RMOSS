...
namespace ForecastingEngine.Evolutionary_Learning_Algo
{
    ...
    public class GSA_Learning : ISupervisedLearning
    {
        ...
        private GSAOptimizer Optimizer;

        public GSA_Learning(ActivationNetwork activationNetwork, int populationSize, int maxIterations, double Go, double alpha)
        {
            ...
            Optimizer = new GSAOptimizer(numberOfNetworksWeights, populationSize, maxIterations);
